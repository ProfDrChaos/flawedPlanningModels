...
;;
;; Adapted by Kayleigh Sleath to test diagnosis of inconsistent parameter types (line 45). 6-4-2023 
...
(:action move_seg_pp_0_60_seg_ppdoor_0_40_north_north_medium
 ...
 :precondition  (and
                 ;; SWAPPED ORDER OF PARAMETERS TO CREATE PARAMETER TYPE ERROR
                 ;; (at-segment ?a seg_pp_0_60)
                 (at-segment seg_pp_0_60 ?a)
