...
;;
;; Adapted by Kayleigh Sleath to test diagnosis of inconsistent numbers of parameters (line 45). 6-4-2023 
...
(:action move_seg_pp_0_60_seg_ppdoor_0_40_north_north_medium
 ...
 :precondition  (and
                 ;; REMOVED PARAMETER 'seg_pp_0_60' TO CREATE INCONSISTENT NUMBER OF PARAMETERS
