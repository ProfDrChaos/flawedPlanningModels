...
;; Adapted by Kayleigh Sleath to test diagnosis of undefined predicate errors (line 27). 28-3-2023 
...
(:predicates
                ;; FOLLOWING LINE REMOVED TO CREATE UNDEFINED PREDICATE ERROR:
